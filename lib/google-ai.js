...
const GENERATIVE_MODEL = process.env.GROQ_GENERATIVE_MODEL || "llama3-8b-8192";
...
export async function getEmbedding(text) {
  for (let attempt = 0; attempt < MAX_RETRIES; attempt++) {
    try {
      ...
      console.log(`Making embedding request to: ${BASE_URL}`);
...
Respond in a natural, conversational way:`;
      ...
      console.log(`Making generation request to Groq: ${GROQ_BASE_URL}`);
